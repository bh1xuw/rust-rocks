...
size_t rocks_livefiles_size(const rocks_livefiles_t* lf, int index) { return lf->rep[index].size; }

const char* rocks_livefiles_name(const rocks_livefiles_t* lf, int index) { return lf->rep[index].name.c_str(); }
...
const char* rocks_livefiles_db_path(const rocks_livefiles_t* lf, int index) { return lf->rep[index].db_path.c_str(); }

uint64_t rocks_livefiles_smallest_seqno(const rocks_livefiles_t* lf, int index) {
  return lf->rep[index].smallest_seqno;
}

uint64_t rocks_livefiles_largest_seqno(const rocks_livefiles_t* lf, int index) { return lf->rep[index].largest_seqno; }

int rocks_livefiles_level(const rocks_livefiles_t* lf, int index) { return lf->rep[index].level; }
...
extern "C" {
uint64_t rocks_column_family_metadata_size(const rocks_column_family_metadata_t* meta) { return meta->rep.size; }
...
extern void rocks_column_family_metadata_destroy(const rocks_column_family_metadata_t* meta) { delete meta; }
}
