...
void rocks_iostats_context_reset(rocks_iostats_context_t* ctx) { reinterpret_cast<IOStatsContext*>(ctx)->Reset(); }

void rocks_iostats_context_to_string(const rocks_iostats_context_t* ctx, unsigned char exclude_zero_counters,
                                     void* s) {  // *mut String
