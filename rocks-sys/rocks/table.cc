...
extern "C" {
  ...
  rocks_plain_table_options_create() {
    return new rocks_plain_table_options_t;
  }

  void rocks_plain_table_options_destroy(
                                         rocks_plain_table_options_t* options) {
    delete options;
  }
...
extern "C" {
  ...
  void rocks_block_based_table_options_set_metadata_block_size(
                                                               rocks_block_based_table_options_t* options, uint64_t val) {
...
extern "C" {
  ...
  rocks_cuckoo_table_options_create() {
    return new rocks_cuckoo_table_options_t;
  }
